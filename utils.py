...
def load_data(dataset_name) :
    if dataset_name == 'mnist' :
        ...
        x = glob(os.path.join(dataset_name, '*.*'))
...
def save_images(images, size, image_path):
    ...
    # trovare una funzione che scriva su file un batch di immagini
    return misc.save_image_grid(inverse_transform(images), image_path, grid_size=size)
